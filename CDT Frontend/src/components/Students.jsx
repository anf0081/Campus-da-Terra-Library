    ...
    <div>
      ...
      <div className="student-detail-container">
        <div className="student-actions">
          <button className="outlined" onClick={() => setSelectedStudent(null)}>← Back to Student List</button>
          <button className="outlined" onClick={() => handleViewDashboard(selectedStudent.id)}>Student Dashboard</button>
          {!isEditing && !isCreating && (
            <button className="outlined" onClick={() => handleEditStart(selectedStudent)}>Edit Student</button>
          )}
        </div>
          ...
          <form onSubmit={handleSave} className="student-form">
            <div className="form-sections">
              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  <label>Middle Name{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <input
                    type="text"
                ...
                <div className="form-group">
                  <label>Last Name{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <input
                    type="text"
                ...
                <div className="form-group">
                  <label>Gender{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <select
                ...
                <div className="form-group">
                  <label>Date of Birth{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <input
                    type="date"
              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  <label>NIF Number{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <input
                    type="text"
              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  <label>Enrollment Length{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <select
                ...
                <div className="form-group">
                  <label>Weekday Attendance{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <select
                ...
                <div className="form-group">
                  <label>Enrollment Start Date{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <input
                    type="date"
                ...
                <div className="form-group checkbox-group">
                  <label>
                    <input
                      ...
                      disabled={user?.role !== 'admin'}
                    />
                    Has siblings at Campus da Terra{user?.role !== 'admin' ? ' (Admin Only)' : ''}
                  </label>
                </div>
                <div className="form-group">
              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  <label>Pricing Category{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <select
                ...
                <div className="form-group">
                  <label>Discount{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <select
                ...
                <div className="form-group">
                  <label>Payment Method{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <select
                ...
                <div className="form-group checkbox-group">
                  <label>
                    <input
                      ...
                      disabled={user?.role !== 'admin'}
                    />
                    Billing Address Same as Home{user?.role !== 'admin' ? ' (Admin Only)' : ''}
                  </label>
                </div>
                {!formData.billingAddressSameAsHome && (
                  <>
                    <div className="form-group">
                      <label>Billing Street Address{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                      <input
                        type="text"
                    ...
                    <div className="form-group">
                      <label>Billing City{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                      <input
                        type="text"
                    ...
                    <div className="form-group">
                      <label>Billing Postal Code{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                      <input
                        type="text"
                    ...
                    <div className="form-group">
                      <label>Billing Country{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                      <input
                        type="text"
                ...
                <div className="form-group">
                  <label>Additional Notes{user?.role !== 'admin' ? ' (Admin Only)' : ''}</label>
                  <textarea
                ...
                <div className="form-group checkbox-group">
                  <label>
                    <input
                      ...
                      disabled={user?.role !== 'admin'}
                    />
                    Signed Tuition Agreement{user?.role !== 'admin' ? ' (Admin Only)' : ''}
                  </label>
                </div>
              </div>

              {/* Administrative - Referral & Motivation (Admin Only) */}
              {user?.role === 'admin' && (
                <div className="form-section">
                  <h3>Referral & Motivation</h3>
                  <div className="form-group">
                ...
                <div className="form-group checkbox-group">
                  <label>
                    <input
                      ...
                      disabled={user?.role !== 'admin' && selectedStudent?.photoConsent}
                    />
                    Photo Consent{user?.role !== 'admin' && selectedStudent?.photoConsent ? ' (Already Consented)' : ''}
                  </label>
                </div>
                <div className="form-group checkbox-group">
                  <label>
                    <input
                      ...
                      disabled={user?.role !== 'admin' && selectedStudent?.contactListConsent}
                    />
                    Contact List Consent{user?.role !== 'admin' && selectedStudent?.contactListConsent ? ' (Already Consented)' : ''}
                  </label>
                </div>
                <div className="form-group checkbox-group">
                  <label>
                    <input
                      ...
                      disabled={user?.role !== 'admin' && selectedStudent?.personalDataConsent}
                    />
                    Personal Data Consent{user?.role !== 'admin' && selectedStudent?.personalDataConsent ? ' (Already Consented)' : ''}
                  </label>
                </div>
                <div className="form-group checkbox-group">
                  <label>
                    <input
                      ...
                      disabled={user?.role !== 'admin' && selectedStudent?.termsAndConditions}
                    />
                    Terms and Conditions Accepted{user?.role !== 'admin' && selectedStudent?.termsAndConditions ? ' (Already Accepted)' : ''}
                  </label>
                </div>

                {user?.role !== 'admin' && (selectedStudent?.photoConsent || selectedStudent?.contactListConsent || selectedStudent?.personalDataConsent || selectedStudent?.termsAndConditions) && (
                  <div className="note" style={{ marginTop: '1rem', fontSize: '0.9rem', color: '#666', fontStyle: 'italic' }}>
                    * To remove any given consent, please contact an administrator.
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="student-detail">
            <div className="detail-sections">
              ...
              <div className="detail-section">
                ...
                <p><strong>Has siblings at Campus da Terra:</strong> {selectedStudent?.siblings ? 'Yes' : 'No'}</p>
